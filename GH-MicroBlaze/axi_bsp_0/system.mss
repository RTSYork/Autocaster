...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gh_player
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = gh_player_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = image_filter
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = image_filter_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = screen_detector
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = screen_detector_0
END
