...
// Limit MAC address to specific machine to keep support happy...
static u8 RemoteMacAddress[XEL_MAC_ADDR_SIZE] =
{
	//0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF // Broadcast
	//0x00, 0x19, 0xD1, 0x89, 0x2D, 0xFC // WV2988
	0xe0, 0xcb, 0x4e, 0x06, 0x2b, 0x69 // Screen PC
};
// Broadcast to 144.32.175.192/27 subnet
