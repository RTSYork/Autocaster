...
//
// On Wed Apr 17 14:24:47 BST 2013
//
...
module mkBlur(CLK,
  ...
  reg IF_x_EQ_0_THEN_lastRow_ELSE_IF_x_EQ_1_0_THEN_l_ETC___d3847;
  ...
  // inlined wires
  assign blurred$wget =
	     { IF_x_EQ_0_THEN_lastRow_ELSE_IF_x_EQ_1_0_THEN_l_ETC___d3847,
	       lastPxl,
	       bin_in } ;
  ...
  begin
    case (x)
	  ...
	  IF_x_EQ_0_THEN_lastRow_ELSE_IF_x_EQ_1_0_THEN_l_ETC___d3847 =
	      lastRow_1278;
      default: IF_x_EQ_0_THEN_lastRow_ELSE_IF_x_EQ_1_0_THEN_l_ETC___d3847 =
		   lastRow_1279;
    endcase
  end
