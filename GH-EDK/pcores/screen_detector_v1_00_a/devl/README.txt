...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\Autocaster\GH-EDK
  logical library name                       : screen_detector_v1_00_a
  top name                                   : screen_detector
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- XPS interface file(s)
  ...
  data/screen_detector_v2_1_0.mpd
  ...
  data/screen_detector_v2_1_0.pao
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/screen_detector_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/screen_detector_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\Autocaster\GH-EDK\C:\Xilinx\14.6\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
